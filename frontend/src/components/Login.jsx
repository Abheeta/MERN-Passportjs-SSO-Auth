/**
 * @file Login.jsx
 * @description Login page component with Google OAuth authentication
 * @requires React
...
// Google logo SVG paths with their respective colors
...
/**
 * Login Component
 * Provides Google OAuth authentication interface for users.
 * Displays a welcome message and Google sign-in button.
 * 
 * @component
 * @returns {JSX.Element} Rendered login view
 */
const Login = () => {
  // Router hook
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center">
      {/* Header Title */}
      <h1 className="mb-12 font-inter text-2xl font-semibold uppercase text-center">
        MERN SSO Authentication using Passportjs Google OAuth2 Strategy
      </h1>
      
      <div className="flex flex-col items-center">
        {/* Login Prompt */}
        <div 
          className="mb-6 w-[22.5rem] text-center font-inter font-semibold capitalize leading-10"
