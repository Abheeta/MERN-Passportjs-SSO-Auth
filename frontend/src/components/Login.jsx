...
return(
    ...
    <div className='flex flex-col justify-center items-center h-screen'>
        <div className='m-12 font-inter font-semibold uppercase leading-[2.5rem]'>
            MERN SSO Authentication using Passportjs Google OAuth2 Strategy with Deployment
        </div>
        
        <div>
                <div className="capitalize text-center font-inter font-semibold leading-[2.5rem] w-[22.5rem]" style={{ color: "rgba(255, 255, 255, 0.60)" }}>
